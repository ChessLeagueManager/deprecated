...
$ext_view	= JRequest::getVar('dwz_view');
...
<?php } else {
	...
	$cssDir		= JURI::base().'components'.DS.'com_clm_dwz'.DS;
	$document->addStyleSheet( $cssDir.DS.'clm_content.css', 'text/css', null, array() );

/////////////////////
// Aufrufen mit z.B.:
// http://localhost/install/index.php?option=com_clm_dwz&view=clm_dwz&zps=66205
/////////////////////
...
<hr>
Die hier dargestellten Wertzahlen befinden sich im Orginal auf <a href="<?php echo $ext_url;?>"><?php echo $ext_url1;?></a>
<?php } ?>
