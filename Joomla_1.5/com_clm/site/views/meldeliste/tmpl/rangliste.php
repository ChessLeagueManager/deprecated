...
<div class="componentheading">Rangliste abgeben : <?php echo $liga[0]->vname; ?></div>
<div><h2>Gruppe : <?php echo $liga[0]->gruppe; ?></h2></div>
<br>
<u><b>Hinweise</u></b> : 
...
<a href="#" onclick="javascript:Pruefbutton()" class="toolbar">
...
<a href="#" onclick="javascript:Sortieren()" class="toolbar">
...
<a href="#" onclick="javascript:location.reload()" class="toolbar">
...
<a href="#" onclick="javascript:document.adminForm.submit()" class="toolbar">
  ...
  <fieldset class="adminform">
   <legend><?php echo "Rangliste Platz 1 - ".count($spieler); ?></legend>
	...
	<tr>
		...
		<td colspan="2" width="10%" class="key" nowrap="nowrap">DWZ</td>
	</tr>
...
<div style=" text-align:right; padding-right:1%"><label for="name" class="hasTip" title="<?php echo JText::_('Das Chess League Manager (CLM) Projekt ist freie, kostenlose Software unter der GNU / GPL. Besuchen Sie unsere Projektseite www.fishpoke.de für die neueste Version, Dokumentationen und Fragen. Wenn Sie an der Entwicklung des CLM teilnehmen wollen melden Sie sich bei uns per E-mail. Wir sind für jede Hilfe dankbar !'); ?>">Sie wollen am Projekt teilnehmen oder haben Verbesserungsvorschläge - <a href="http://www.fishpoke.de">CLM Projektseite</a></label></div>