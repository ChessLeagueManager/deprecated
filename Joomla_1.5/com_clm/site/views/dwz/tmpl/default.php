...
<div id="pdf">
<div class="pdf"><a href="index.php?option=com_clm&amp;view=dwz&amp;format=clm_pdf&amp;layout=dwz&amp;saison=<?php echo $sid; ?>&amp;zps=<?php echo $urlzps ?>&amp;Itemid=<?php echo $itemid; ?>" title="<?php echo JText::_('CLUB_RATING_PDF'); ?>"><img src="<?php echo $imageDir.'pdf_button.png'; ?>" alt="PDF"  /></a></div>
</div>
</div>
<div class="clr"></div>
