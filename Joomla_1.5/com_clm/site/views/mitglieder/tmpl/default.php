...
<div id="mitglieder">
	...
	<table class="admintable">
        ...
        <tr>
            ...
            <td align="center"><a href="index.php?option=com_clm&amp;view=mitglieder_details&amp;saison=<?php echo $sid; ?>&amp;zps=<?php echo $zps; ?>&amp;mglnr=<?php echo $spieler->id; ?>"><img src="<?php echo JURI::base(); ?>components/com_clm/images/edit_f2.png"/></a></td>
            <td align="center">
            <a href="index.php?option=com_clm&amp;view=mitglieder&amp;saison=<?php echo $sid; ?>&amp;zps=<?php echo $zps; ?>&amp;mglnr=<?php echo $spieler->id; ?>&amp;layout=delete"><img src="<?php echo JURI::base(); ?>components/com_clm/images/cancel_f2.png"/></a></td>
        </tr>
        <?php $i++;} ?> 
