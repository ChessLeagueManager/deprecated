...
<div class="pdf"><a href="index.php?option=com_clm&amp;view=turnier_teilnehmer&amp;format=clm_pdf&amp;layout=teilnehmer&amp;turnier=<?php echo $turnierid;?>&amp;Itemid=99"><img src="<?php echo $imageDir.'pdf_button.png'; ?>" title="<?php echo JText::_('TOURNAMENT_PARTICIPANTLIST_PRINT'); ?>"  class="CLMTooltip" /></a></div>
<?php 
