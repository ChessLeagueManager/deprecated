...
#turnier_player .tp_col_playerInfo_small { margin-right: <?php echo $joomGalleryPhotosWidth + 10; ?>px;}
#turnier_player .tp_col_playerPhoto		{ width:<?php echo $joomGalleryPhotosWidth; ?>px;}
#turnier_player .tp_col_playerPhoto img	{ width:<?php echo $joomGalleryPhotosWidth-10; ?>px;}
...
#clm table .anfang, #clm table .ende, #clm .clmbox, #spieler table.spielerverlauf th, #spieler div.spielerverlauf, #spieler .title, #clm_suckerfish, #clm_suckerfish li a, #clm_suckerfish li ul{ background-color: <?php echo $clm_subth; ?>; color: <?php echo $clm_tableth_s2; ?> !important;}
