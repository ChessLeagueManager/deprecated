...
class CLMModelRunde extends JModel
{
	...
	$id	= @$options['id'];
		...
		$query = " SELECT a.*, r.datum, r.name as rname, r.bemerkungen as comment, r.published as pub,"
...
/////////////
	...
	// ordering für Rangliste -> Ersatz für direkten Vergleich
		$query = "SELECT a.order, a.runden, a.durchgang, a.b_wertung, a.liga_mt FROM #__clm_liga as a"  //klkl
			." WHERE id = ".$liga
			." AND sid = ".$sid
			;
		$db->setQuery($query);
