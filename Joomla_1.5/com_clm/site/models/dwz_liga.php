...
class CLMModelDWZ_Liga extends JModel
{
	...
	$query = " SELECT tln_nr, COUNT(a.zps) as count, SUM(m.DWZ) as dwz, SUM(Punkte) as punkte, SUM(I0) as i0, SUM(Partien) as partien, SUM(We) as we, SUM(Leistung) as leistung, SUM(EFaktor) as efaktor, SUM(Niveau) as niveau, SUM(d.DWZ) as dsbDWZ"
