...
class CLMViewInfo extends JView {
	...
	function display () {
		...
		if (substr_count($joomlaVersion, '1.5')) {
			...
			if($gruppe['Administrator'] > 6 OR $gruppe['Super Benutzer'] > 6) { $admin_access = 'YES';}
			else { $admin_access ='NO'; }
			//////////////////////////////////////////////////////////////////////////////////
	...
	<div class="icon">
		...
		<span><?php echo JText::_( 'INFO_BUTTON_SEASON' );?></span></a> </div>
	</div>
	...
	<div class="icon-container">
	<div class="icon"> <a href="index.php?option=com_clm&section=swt" title=""> <img src="components/com_clm/images/clm_generic.png" align="middle" border="0" alt="" /> <span><?php echo JText::_( 'INFO_BUTTON_SWT' );?></span></a> </div>
	</div>
	...
	<?php $Dir = JPATH_ADMINISTRATOR .DS. 'components'.DS.'com_clm'; $data = JApplicationHelper::parseXMLInstallFile($Dir.DS.'clm.xml');
