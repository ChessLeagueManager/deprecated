...
<h1> <?php echo $rnd[0]->name.','.JTEXT::_('CHECK_ROUND').$rnd[0]->nr.','.JTEXT::_('CHECK_DATE').' '.JHTML::_('date',  $rnd[0]->datum, JText::_('%d. %B %Y')); ?> </h1>
<?php echo JTEXT::_('CHECK_COMMENT');?>

 <div class="col width-50">
  <fieldset class="adminform">
   <legend><?php echo JText::_( 'CHECK_LEGEND_DOUBLE')." - ".JTEXT::_('CHECK_DATE').' '.JHTML::_('date',  $rnd[0]->datum, JText::_('%d. %B %Y')); ?></legend>
